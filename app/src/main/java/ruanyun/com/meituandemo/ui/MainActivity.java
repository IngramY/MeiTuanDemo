package ruanyun.com.meituandemo.ui;
...
import ruanyun.com.meituandemo.app.MyApplication;
import ruanyun.com.meituandemo.ui.client.groupbuy.GroupBuyActivity;
import ruanyun.com.meituandemo.ui.client.merchant.MerchantActivity;
import ruanyun.com.meituandemo.ui.client.mine.MineActivity;
import ruanyun.com.meituandemo.ui.client.more.MoreActivity;
...
public class MainActivity extends TabActivity implements OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.img_groupbuy:
                ...
                img_groupbuy.setBackgroundResource(R.mipmap.ic_menu_deal_on);
                text_groupbuy.setTextColor(getResources().getColor(R.color.green));
                img_merchant.setBackgroundResource(R.mipmap.ic_menu_poi_off);
                ...
                img_more.setBackgroundResource(R.mipmap.ic_menu_more_off);
            ...
            case R.id.img_merchant:
                ...
                img_groupbuy.setBackgroundResource(R.mipmap.ic_menu_deal_off);
                text_groupbuy.setTextColor(getResources().getColor(R.color.textgray));
                img_merchant.setBackgroundResource(R.mipmap.ic_menu_poi_on);
            ...
            case R.id.img_more:
                ...
                img_mine.setBackgroundResource(R.mipmap.ic_menu_user_off);
                text_mine.setTextColor(getResources().getColor(R.color.textgray));
                img_more.setBackgroundResource(R.mipmap.ic_menu_more_on);
    ...
    private void getScreenDisplay(){
        ...
        myApplication.setScreenWidth(screenWidth);
